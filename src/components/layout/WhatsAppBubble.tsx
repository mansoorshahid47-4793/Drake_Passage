  ...
  return (
    <aside aria-label="Quick contact" className="fixed bottom-5 right-5 z-30">
      <a
        ...
        className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-navy shadow-lg hover:scale-105 transition-transform duration-[var(--dur-micro)]"
      >
